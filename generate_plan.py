...
YOUR_EMAIL = "ضع_إيميلك_هنا@gmail.com" # <--- تأكد من وضع إيميلك هنا

# إعداد العميل مع تحديد الإصدار الصريح
...
def generate_full_content_plan(niche):
    ...
    # استخدام المسمى المختصر والمباشر للموديل
...
if __name__ == "__main__":
    ...
    try:
        ...
        # نرفع الخطأ لكي تظهر العلامة حمراء إذا فشل فعلياً
        raise e
